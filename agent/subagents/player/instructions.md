...
4. Judge against the brief and retro defaults: title reachable, start works, scripted play produces state transitions, no console errors, Sweetie-16 look, readable HUD, juice present on core actions.
